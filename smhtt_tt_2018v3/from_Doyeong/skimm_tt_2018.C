...
int main(int argc, const char* argv[])
{
  ...
  std::cout<<"SampleName = "<<SampleName<<endl;
   ...
   for (Long64_t jentry=0; jentry<nentriesToCheck;jentry++)
     {
       ...
       bool event_range = false;
       
       if (SampleName=="data_Tau_Run2018D_1" && jentry <= 2500000 ) 
	 event_range = true;
       else if (SampleName=="data_Tau_Run2018D_2" && jentry > 2500000 && jentry<=5000000 )
         event_range = true;
       else if (SampleName=="data_Tau_Run2018D_3" && jentry > 5000000 && jentry<=7500000 )
         event_range = true;
       else if (SampleName=="data_Tau_Run2018D_4" && jentry > 7500000 && jentry<=10000000 )
         event_range = true;
       else if (SampleName=="data_Tau_Run2018D_5" && jentry > 10000000 && jentry<=15000000 )
         event_range = true;
       else if (SampleName=="data_Tau_Run2018D_6" && jentry > 15000000 && jentry<=20000000 )
         event_range = true;
       else if (SampleName=="data_Tau_Run2018D_7" && jentry > 20000000 && jentry<=25000000 )
         event_range = true;
       else if (SampleName=="data_Tau_Run2018D_8" && jentry > 25000000 )
         event_range = true;

       if(event_range==false) continue;
