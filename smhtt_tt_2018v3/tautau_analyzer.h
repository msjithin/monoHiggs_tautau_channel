...
public :
  ...
  /* TF1* mvis_corr = new TF1("mvis_corr","0.0003* x^2 - 0.0423*x + 2.3823",0,1000);   */
...
void tautau_analyzer::setMyEleTau(int tau1Index, int tau2Index){
  ...
  /* TLorentzVector tmptau = my_tau1P4; */
  /* if ( my_tau1P4.Pt() > my_tau1P4.Pt()) */
  /*   {  */
  /*     Tau1Index=tau1Index; Tau2Index=tau2Index;  */
  /*   } */
  /* else */
  ...
  /*     my_tau1P4 = my_tau2P4; */
  /*     my_tau2P4 = tmptau; */
  /*     my_genmatching_l1 = myGenMaching(Tau2Index); */
  /*     my_genmatching_l2 = myGenMaching(Tau1Index); */
  /*     tau1dm  = tau_DecayMode->at(Tau2Index); */
  /*     tau2dm  = tau_DecayMode->at(Tau1Index); */
  /*   } */
