		  ...
		  )
		 {
		   ...
		   if( t1Charge * t2Charge < 0 )
		       ...
		       if (eVetoZTTp001dxyzR0==0 && muVetoZTTp001dxyzR0==0)
			 {
			   ...
			   {
			     makeMyPlot("h", 0, 0, eventWeight);
			     
			     //dr cut
			     double dr_etau=mytau1.DeltaR(mytau2);
			     if(dr_etau>0.5)
			       {
				 makeMyPlot("i", 0, 0, eventWeight);
				 reorder = 0;
		  ...
		  )
		 {
		   ...
		   if( t1Charge * t2Charge < 0 )
		       ...
		       if (eVetoZTTp001dxyzR0==0 && muVetoZTTp001dxyzR0==0)
			 {
			   ...
			   {
			     makeMyPlot("fh",0, 0, eventWeight);
				
			     //dr cut
			     double dr_etau=mytau1.DeltaR(mytau2);
			     if(dr_etau>0.5)
			       {
				 makeMyPlot("fi",0, 0, eventWeight);
...
void smhtt_2018::BookHistos(const char* file2)
{
