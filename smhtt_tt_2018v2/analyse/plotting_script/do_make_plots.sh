...
#inFile=$1
declare -a plotList=("tau1Pt" "tau1Eta" "tau1Phi" "tau2Pt" "tau2Eta" "tau2Phi" "tau1DecayMode" "tau2DecayMode" "tau1Iso" "tau2Iso" "deltaR" "deltaPhi" "deltaEta" "nJet" "met" "metPhi" "mT_eMet" "visMass" "higgsPt" "trigger" "tau1rawiso" "tau2rawiso" "genmatch1" "genmatch2") 
