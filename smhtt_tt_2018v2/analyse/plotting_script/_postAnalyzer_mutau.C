...
int main(int argc, char** argv)
{
  ...
  else if (sample=="ZTT1jet"){ xs=LOtoNNLO_DY*1012.5; weight=0.629380356;}
  else if (sample=="ZTT2jet"){ xs=LOtoNNLO_DY*332.8; weight=0.551761047;}
  else if (sample=="ZTT3jet"){ xs=LOtoNNLO_DY*101.8; weight=0.599113102;}
  else if (sample=="ZTT4jet"){ xs=LOtoNNLO_DY*54,8; weight=0.820156851;}
  ...
  cout<<sample.c_str()<<"  "<<weight<<"    ngen="<<ngen<<endl;
