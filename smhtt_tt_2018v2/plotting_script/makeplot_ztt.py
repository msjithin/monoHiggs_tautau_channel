...
if not (type(HistSelected)==ROOT.TH1F and type(HistSelected_1)==ROOT.TH1F):
  exitmessage = 'Histogram NOT found!!!!!!!!!!!!!!!!!!!!!!!!!!!! '+ str(histoname)
...
if(year_=='2017'):
  ...
  if bkg_=="DY" :
    ...
    weight_norm=0.6992308
  elif bkg_=="DY2":
    weight_norm=0.796501057
  elif bkg_=="DY3":
    weight_norm=0.982524791
  elif bkg_=="DY4":
    weight_norm=0.819765054
  elif bkg_=="TTTo2L2Nu":
    weight_norm=0.407311
  elif bkg_=="TTToHadronic":
    weight_norm=0.376066
