...
public :
  ...
  TLorentzVector tau1P4, tau2P4, metP4;
   ...
   smhtt_2018(const char* file1, const char* file2, string isMC);
   virtual ~smhtt_2018();
...
smhtt_2018::smhtt_2018(const char* file1, const char* file2, string isMC)
{
...
void smhtt_2018::Init(TChain *tree, string _isMC_)
{
