...
./_postAnalyzer_mutau.exe ../files_initial/TauA_final.root files_nominal/TauA_final.root data_obs data_obs 0 
...
./_postAnalyzer_mutau.exe ../files_initial/TauB_final.root files_nominal/TauB_final.root data_obs data_obs 0 
./_postAnalyzer_mutau.exe ../files_initial/TauC_final.root files_nominal/TauC_final.root data_obs data_obs 0 
./_postAnalyzer_mutau.exe ../files_initial/TauD_PromptReco_final.root files_nominal/TauD_PromptReco_final.root data_obs data_obs 0 
