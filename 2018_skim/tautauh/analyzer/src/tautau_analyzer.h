...
public :
  ...
  /* TFile * frawff = TFile::Open("sf_files/ComputeFF2018/ff_files_tt_2018/uncorrected_fakefactors_tt.root"); */
  ...
  //TF1* dy_corr = new TF1("dy_corr","0.0003* x^2 - 0.0423*x + 2.3823",0,1000);   
  /* //TF1 *fa2 = new TF1("fa2","TMath::DiLog(x)",0,10); */
  /* TFile *fosssclosure  = TFile::Open("sf_files/ComputeFF2018/ff_files_tt_2018/FF_QCDcorrectionOSSS_tt.root"); */
  ...
  //using namespace tau_trigger;
  /* SFProvider* tauTrgsf_m=new SFProvider("sf_files/TauTriggerSFs/data/2018_tauTriggerEff_DeepTau2017v2p1.root","ditau", "Medium"); */
  /* SFProvider* tauTrgsf_vl=new SFProvider("sf_files/TauTriggerSFs/data/2018_tauTriggerEff_DeepTau2017v2p1.root","ditau", "VVVLoose"); */
  ...
  // Declaration of leaf types
   ...
   vector<float>   *tau_byRawDeepTau2017v2p1VSjet;
   ...
   TBranch        *b_tau_byRawDeepTau2017v2p1VSjet;   //!
   ...
   void sortTauIndices(vector<int> tauIndices , int& tau1 , int& tau2 );
   int getZCand();
   int get_t_Cand();
   int get_tbar_Cand();
...
void tautau_analyzer::Init(TChain *tree, string _isMC_ , string sampleName)
{
  ...
  tau_byRawDeepTau2017v2p1VSjet = 0;
  ...
  fChain->SetBranchAddress("tau_byRawDeepTau2017v2p1VSjet", &tau_byRawDeepTau2017v2p1VSjet, &b_tau_byRawDeepTau2017v2p1VSjet);
...
void tautau_analyzer::setMyEleTau(int tau1Index, int tau2Index){
  ...
  if(is_MC){
    ...
    /* cout <<"dm0   0.987 "<< get_BinContent( h_tauesSF, 0)<<endl; */
    /* cout <<"dm1   0.995 "<< get_BinContent( h_tauesSF, 1)<<endl; */
    /* cout <<"dm10  0.988 "<< get_BinContent( h_tauesSF, 10)<<endl; */
    /* cout <<"dm11  0.988 "<< get_BinContent( h_tauesSF, 11)<<endl; */
    /* if (my_genmatching_l2>=5 && tau2dm==0) my_tau2P4=my_tau2P4*0.987; */
    /* else if (my_genmatching_l2>=5 && tau2dm==1) my_tau2P4=my_tau2P4*0.995; */
    /* else if (my_genmatching_l2>=5 && tau2dm==10) my_tau2P4=my_tau2P4*0.988; */
    if (  (my_genmatching_l2==1 || my_genmatching_l2==3) && tau2dm==0 )
      my_tau2P4=my_tau2P4*0.968;
  ...
  if(is_MC){
    ...
    /* if (my_genmatching_l1>=5 && tau1dm==0) my_tau1P4=my_tau1P4*0.987; */
    /* else if (my_genmatching_l1>=5 && tau1dm==1) my_tau1P4=my_tau1P4*0.995; */
    /* else if (my_genmatching_l1>=5 && tau1dm==10) my_tau1P4=my_tau1P4*0.988; */
    if (  (my_genmatching_l1==1 || my_genmatching_l1==3) && tau1dm==0 )
      my_tau1P4=my_tau1P4*0.968;
  ...
  pass3rdLeptonVeto = ( eVetoZTTp001dxyz(Tau1Index, Tau2Index) && mVetoZTTp001dxyz(Tau1Index, Tau2Index) && passDiElectronVeto(0) );
