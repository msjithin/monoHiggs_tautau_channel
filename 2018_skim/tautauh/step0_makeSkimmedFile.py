...
os.popen('ls -d /hdfs/store/user/jmadhusu/MC2018_Autumn18_monoHiggs_05Apr2021/*/*/*/* > mc_dir_list')
...
os.popen('ls -d /hdfs/store/user/jmadhusu/data2018_04Apr2021/Tau/*/*/* > data_dir_list')
